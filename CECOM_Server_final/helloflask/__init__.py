...
def about_1():
    if not session.get('logged_in'):
        ...
        return render_template('2019_1.html', posts=posts, title='About')
...
def about_2():
    if not session.get('logged_in'):
        ...
        posts = Post.query.all()
        return render_template('2019_2.html', posts=posts, title='About')
...
def about_v():
    if not session.get('logged_in'):
        ...
        posts = Post.query.all()
        return render_template('2019_v.html', posts=posts, title='About')
